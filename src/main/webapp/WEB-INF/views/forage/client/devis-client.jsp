...
<head>
    <meta charset="UTF-8">
    <title>Liste devis Client</title>
...
<body>
    <div class="container">
        ...
        <h2 class="text-center mb-4">Liste devis Client</h2>
                        ...
                        <c:when test="${not empty devis}">
                            <c:forEach var="d" items="${devis}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/devis/modifier/${d.id}" class="btn btn-secondary">
                                            Modifier
                                        </a>
                                    </td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/devis/supprimer/${d.id}" class="btn btn-danger">
                                            Supprimer
                                        </a>
                                    </td>
                                    <td>
