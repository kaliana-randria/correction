...
<div class="container mt-5">
    ...
    <h2 class="text-center mb-4">Modifier un Note</h2>
    ...
    <form:form action="${pageContext.request.contextPath}/note/modifier"
               method="post"
               modelAttribute="note">
        ...
        <div class="text-center">
            ...
            <a href="${pageContext.request.contextPath}/note/list" class="btn btn-secondary">Annuler</a>
        </div>
