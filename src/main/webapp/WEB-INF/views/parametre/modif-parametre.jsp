...
<head>
    <meta charset="UTF-8">
    <title>Modifier Parametre</title>
...
<div class="container mt-5">
    ...
    <h2 class="text-center mb-4">Modifier un Parametre</h2>
    ...
    <form:form action="${pageContext.request.contextPath}/parametre/modifier"
               method="post"
        ...
        <div class="text-center">
            ...
            <a href="${pageContext.request.contextPath}/parametre/list" class="btn btn-secondary">Annuler</a>
        </div>
